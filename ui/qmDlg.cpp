...
/*
 * ALL THIS FILE MUST BE REWRITED TO MOVE TO QT5
 * */
...
void QMDlg::init()
{
  ...
  QHBoxLayout *settingsBoxLayout = new QHBoxLayout(qmSettingsBox->layout()->widget());
...
{
  qmDlgData.qmType = typeStr.toUtf8().constData();
  updateSettingsBox();
}
